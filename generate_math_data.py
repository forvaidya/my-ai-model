...
# ============================================================================
# ASSETS & UNITS (singular forms)
# ============================================================================

ASSETS = ["$", "₹", "marble", "candy", "book", "pencil"]
...
def format_asset_value(value: int, asset: str) -> str:
    ...
    if asset in ["$", "₹"]:
        ...
        # For non-currency assets, pluralize if needed
        pluralized_asset = pluralize(asset, value)
        return f"{value} {pluralized_asset}"
...
def generate_prompt_one_operand(actor1: str, asset: str, value: int) -> str:
    ...
    variations = [
        f"{actor1} has {formatted_value}.",
        f"{actor1} owns {formatted_value}.",
        f"{actor1} has {formatted_value}.",
    ]
    return random.choice(variations)
...
def generate_prompt_two_operands(
    ...
    if is_addition:
        ...
        variations = [
            f"{actor1} had {formatted_value1} and {pronoun} {verb} {formatted_value2} {preposition} {actor2}.",
            f"{actor1}, who had {formatted_value1}, {verb} {formatted_value2} {preposition} {actor2}.",
            f"Having {formatted_value1}, {actor1} {verb} {formatted_value2} {preposition} {actor2}.",
            f"{actor1} had {formatted_value1}. {pronoun.capitalize()} {verb} {formatted_value2} {preposition} {actor2}.",
        ]
    else:
        verb = random.choice(SUBTRACTION_VERBS)
        variations = [
            f"{actor1} had {formatted_value1} and {pronoun} {verb} {formatted_value2} to {actor2}.",
            f"{actor1}, who had {formatted_value1}, {verb} {formatted_value2} to {actor2}.",
            f"Having {formatted_value1}, {actor1} {verb} {formatted_value2} to {actor2}.",
            f"{actor1} had {formatted_value1}. {pronoun.capitalize()} {verb} {formatted_value2} to {actor2}.",
        ]
...
def generate_example() -> Dict[str, Any]:
    ...
    if num_operands == 1:
        ...
        # For subtraction, ensure left quantity > right quantity (for kids' model)
        if not is_addition and value1 <= value2:
